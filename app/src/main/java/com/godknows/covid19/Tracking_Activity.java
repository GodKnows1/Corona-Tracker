...
public class Tracking_Activity extends FragmentActivity implements OnMapReadyCallback {
        ...
        user_location.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot postSnapshot:dataSnapshot.getChildren()){
                    ...
                    double di=distance(currentUser,friend);

                    mMap.addMarker(new MarkerOptions().position(friendLocation).title(tracking.getEmail()).snippet("Distance" + new DecimalFormat("#.#").format(di))
